...
writer = Agent(
  ...
  backstory="""You are a business writer, known for your insightful and engaging dialogs. 
...
task2 = Task(
  ...
  Two  characters discuss strategies for negotiating. Why it's important.  
  ...
  discussing the tactics to get negotiate more often. Time, cost, and other factors are at play.
  The dialog will clearly indicate who is speaking and their emotions.
  The negotiators will both try to negotiate.
