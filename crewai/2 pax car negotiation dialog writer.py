...
task2 = Task(
  description="""Write a long dialog for a play with at least 10 lines for each character. The play is about negotiation. The characters
   are negotiating the price of a new car.Develop an engaging dialog between two people that are 
  negotiating the cost, and ameneties of a new car.
