...
# )
writer = Agent(
  role='webinar advisor',
  goal='Craft compelling dialog',
  backstory="""You are a webinar expert writer, known for your insightful and engaging dialogs. 
  You have a deep understanding of the technology. 
...
task2 = Task(
  ...
  Two female characters discuss strategies for preparing a webinar. 
  ...
  discussing the tactics for a successful webinar. 
  Time, cost, and other factors are at play.
